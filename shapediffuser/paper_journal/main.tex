...
saw---determines whether the amortized model is an IK \emph{solver} or
merely an IK \emph{regressor} that happens to be conditioned well.
\todo{Mode recall and diversity on held-out morphologies, against
ground-truth enumeration on each test arm: running.}
