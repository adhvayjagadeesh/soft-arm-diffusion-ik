...
success. Panel (b) shows the morphology manipulation. Training fresh models
on two-segment and six-segment versions of the arm adds or removes actuation
freedom, and the accuracy gap widens monotonically with segment count, with
the obstacle-task gap reaching 100 percent versus 1 percent at six segments.
...
\item Morphology, single seed per arm. MLP error 1.7 mm at 75 percent
success with two segments, 13.5 mm at 5 percent with four, 33.9 mm at 1.2
percent with six. Diffusion 0.11, 0.28, 0.92 mm with at least 99.8 percent
success throughout. Obstacle task at six segments, 100 percent versus 1
percent.
\end{itemize}
