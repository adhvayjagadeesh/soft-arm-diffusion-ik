...
single flexible backbone. The backbone is a $3.18\,$mm ($1/8''$) structural
...
exactly. Printed holes come out undersized by a machine-dependent amount, so
the bore is sized from a printed gauge coupon rather than nominally, and the
same offset applies to all six. \todo{report measured disc-to-disc hole
scatter and the bore offset used}
