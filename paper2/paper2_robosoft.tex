% ============================================================================
%  PAPER 2 - follow-up to the sim-to-sim RA-L study. INTRODUCTION + METHODS.
%
%  FORMAT: IEEE-RAS conference format (ieeeconf.cls), as used by RoboSoft.
%  Verified against the RAS PaperCept author kit and the RoboSoft CFP:
%    - US Letter, two column, 10pt
%    - 6 pages INCLUDING references; up to 2 extra pages purchasable
%  RoboSoft 2027 is in Brisbane; theme "Soft Robotics in the Wild".
%  VERIFY the 2027 author kit at robosoft27.com before submitting - page
%  limits and anonymity policy are set per-edition.
%
%  OVERLEAF: this file needs ieeeconf.cls in the same project. Get it from
%  the RAS support page (ieeeconf.zip) or copy the vendored one from your
%  existing paper directory. Overleaf does NOT ship ieeeconf by default.
%
%  Placeholders print in red via \todo{}. Search "TODO" before sending.
...
% IEEE-RAS conferences are normally single-blind (named authors), unlike
% RA-L which is double-anonymous. CONFIRM in the RoboSoft 2027 CFP.
...
A prior controlled simulation study~\cite{prior} established three results
...
Hardware also makes one of the prior study's framings natural rather than
...
\begin{enumerate}
  ...
  and a full port of the prior study's evaluation suite. All fabrication
...
explicitly flagged, in the prior study's Cosserat domain. It is applied
...
Code, fabrication templates, calibration procedures, and per-experiment
result files are available at \todo{repository URL}. Note that this must be
replaced with an anonymized mirror if the venue uses double-anonymous review.

% ============================================================================
\begin{thebibliography}{99}

\bibitem{prior}
\todo{Self-citation to the sim-to-sim paper. Replace with the published
reference, or cite as an anonymous preprint if under double-anonymous
review.}
